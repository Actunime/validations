...
export const MediaTitleBody = z.object({
  default: z.string().trim().min(2, "le nom doit contenir au moins 2 caractères"),
...
export const YoutubeURLStringBody = z
  .string()
  .trim()
  .regex(youtubeUrlRegex, { message: "L'URL doit être une URL de vidéo YouTube valide." });
